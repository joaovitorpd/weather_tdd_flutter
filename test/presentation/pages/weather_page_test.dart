...
import 'package:weather_tdd_flutter/presentation/bloc/weather_event.dart';
import 'package:weather_tdd_flutter/presentation/bloc/weather_state.dart';
...
void main() {
  ...
  testWidgets(
    'should progress indicator when state is loading',
    (WidgetTester tester) async {
      //arrange
